...
export class TabsComponent implements OnInit {
  ...
  closeTabsElement(e) {
    if (this.tabsElement && this.navbar_button_toggle) {
      var container = $(this.tabsElement.nativeElement);
      var buttonToggle = $(this.navbar_button_toggle.nativeElement);
  ...
  ngOnInit() {
    if (this.tabsElement && this.navbar_button_toggle && this.navbar_collapse) {
      var menuElement = $(this.tabsElement.nativeElement).find("#HeaderTabs li");
      //console.log("menuElement", menuElement);
      var menuCollapse = $(this.navbar_collapse.nativeElement);
      var buttonToggle = $(this.navbar_button_toggle.nativeElement);
